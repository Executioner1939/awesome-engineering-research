[Skip to main content](https://moonrepo.dev/docs/guides/examples/storybook#__docusaurus_skipToContent_fallback)
...
> We highly suggest reading our documentation on [using Vite (and Vitest) with moon](https://moonrepo.dev/docs/guides/examples/vite) and
> [using Jest with moon](https://moonrepo.dev/docs/guides/examples/jest) for a more holistic view.

## Setup [​](https://moonrepo.dev/docs/guides/examples/storybook\#setup "Direct link to Setup")

This section assumes Storybook is being used with Vite, and is integrated on a per-project basis.

After setting up Storybook, ensure [`moon.*`](https://moonrepo.dev/docs/config/project) has the following tasks:
...
### Vite integration [​](https://moonrepo.dev/docs/guides/examples/storybook\#vite-integration "Direct link to Vite integration")
...
### Webpack integration [​](https://moonrepo.dev/docs/guides/examples/storybook\#webpack-integration "Direct link to Webpack integration")
...
### Jest integration [​](https://moonrepo.dev/docs/guides/examples/storybook\#jest-integration "Direct link to Jest integration")
...
## Configuration [​](https://moonrepo.dev/docs/guides/examples/storybook\#configuration "Direct link to Configuration")
...
- [Setup](https://moonrepo.dev/docs/guides/examples/storybook#setup)
  - [Vite integration](https://moonrepo.dev/docs/guides/examples/storybook#vite-integration)
  - [Webpack integration](https://moonrepo.dev/docs/guides/examples/storybook#webpack-integration)
  - [Jest integration](https://moonrepo.dev/docs/guides/examples/storybook#jest-integration)
- [Configuration](https://moonrepo.dev/docs/guides/examples/storybook#configuration)