[Skip to main content](https://moonrepo.dev/docs/guides/wasm-plugins#__docusaurus_skipToContent_fallback)
...
[moon](https://moonrepo.dev/moon) and [proto](https://moonrepo.dev/proto) plugins can be written in
...
## Powered by Extism [​](https://moonrepo.dev/docs/guides/wasm-plugins\#powered-by-extism "Direct link to Powered by Extism")
...
## Concepts [​](https://moonrepo.dev/docs/guides/wasm-plugins\#concepts "Direct link to Concepts")

Before we begin, let's talk about a few concepts that are critical to WASM and our plugin systems.

### Plugin identifier [​](https://moonrepo.dev/docs/guides/wasm-plugins\#plugin-identifier "Direct link to Plugin identifier")
...
### Virtual paths [​](https://moonrepo.dev/docs/guides/wasm-plugins\#virtual-paths "Direct link to Virtual paths")
...
#### File system caveats [​](https://moonrepo.dev/docs/guides/wasm-plugins\#file-system-caveats "Direct link to File system caveats")
...
### Host environment [​](https://moonrepo.dev/docs/guides/wasm-plugins\#host-environment "Direct link to Host environment")
...
[virtual path](https://moonrepo.dev/docs/guides/wasm-plugins#virtual-paths).
...
### Host functions & macros [​](https://moonrepo.dev/docs/guides/wasm-plugins\#host-functions--macros "Direct link to Host functions & macros")
...
#### Converting paths [​](https://moonrepo.dev/docs/guides/wasm-plugins\#converting-paths "Direct link to Converting paths")
...
#### Environment variables [​](https://moonrepo.dev/docs/guides/wasm-plugins\#environment-variables "Direct link to Environment variables")
...
#### Executing commands [​](https://moonrepo.dev/docs/guides/wasm-plugins\#executing-commands "Direct link to Executing commands")
...
#### Sending requests [​](https://moonrepo.dev/docs/guides/wasm-plugins\#sending-requests "Direct link to Sending requests")
...
#### Logging [​](https://moonrepo.dev/docs/guides/wasm-plugins\#logging "Direct link to Logging")
...
## Configuring plugin locations [​](https://moonrepo.dev/docs/guides/wasm-plugins\#configuring-plugin-locations "Direct link to Configuring plugin locations")
...
### `file` [​](https://moonrepo.dev/docs/guides/wasm-plugins\#file "Direct link to file")
...
### `github` [​](https://moonrepo.dev/docs/guides/wasm-plugins\#github "Direct link to github")
...
### `https` [​](https://moonrepo.dev/docs/guides/wasm-plugins\#https "Direct link to https")
...
## Creating a plugin [​](https://moonrepo.dev/docs/guides/wasm-plugins\#creating-a-plugin "Direct link to Creating a plugin")
...
## Building and publishing [​](https://moonrepo.dev/docs/guides/wasm-plugins\#building-and-publishing "Direct link to Building and publishing")
...
### Building, optimizing, and stripping [​](https://moonrepo.dev/docs/guides/wasm-plugins\#building-optimizing-and-stripping "Direct link to Building, optimizing, and stripping")
...
### Manually create releases [​](https://moonrepo.dev/docs/guides/wasm-plugins\#manually-create-releases "Direct link to Manually create releases")
...
### Automate releases [​](https://moonrepo.dev/docs/guides/wasm-plugins\#automate-releases "Direct link to Automate releases")
...
- [Powered by Extism](https://moonrepo.dev/docs/guides/wasm-plugins#powered-by-extism)
- [Concepts](https://moonrepo.dev/docs/guides/wasm-plugins#concepts)
  - [Plugin identifier](https://moonrepo.dev/docs/guides/wasm-plugins#plugin-identifier)
  - [Virtual paths](https://moonrepo.dev/docs/guides/wasm-plugins#virtual-paths)
    - [File system caveats](https://moonrepo.dev/docs/guides/wasm-plugins#file-system-caveats)
  - [Host environment](https://moonrepo.dev/docs/guides/wasm-plugins#host-environment)
  - [Host functions & macros](https://moonrepo.dev/docs/guides/wasm-plugins#host-functions--macros)
    - [Converting paths](https://moonrepo.dev/docs/guides/wasm-plugins#converting-paths)
    - [Environment variables](https://moonrepo.dev/docs/guides/wasm-plugins#environment-variables)
    - [Executing commands](https://moonrepo.dev/docs/guides/wasm-plugins#executing-commands)
    - [Sending requests](https://moonrepo.dev/docs/guides/wasm-plugins#sending-requests)
    - [Logging](https://moonrepo.dev/docs/guides/wasm-plugins#logging)
- [Configuring plugin locations](https://moonrepo.dev/docs/guides/wasm-plugins#configuring-plugin-locations)
  - [`file`](https://moonrepo.dev/docs/guides/wasm-plugins#file)
  - [`github`](https://moonrepo.dev/docs/guides/wasm-plugins#github)
  - [`https`](https://moonrepo.dev/docs/guides/wasm-plugins#https)
- [Creating a plugin](https://moonrepo.dev/docs/guides/wasm-plugins#creating-a-plugin)
- [Building and publishing](https://moonrepo.dev/docs/guides/wasm-plugins#building-and-publishing)
  - [Building, optimizing, and stripping](https://moonrepo.dev/docs/guides/wasm-plugins#building-optimizing-and-stripping)
  - [Manually create releases](https://moonrepo.dev/docs/guides/wasm-plugins#manually-create-releases)
  - [Automate releases](https://moonrepo.dev/docs/guides/wasm-plugins#automate-releases)