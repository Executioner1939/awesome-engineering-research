[Skip to main content](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#__docusaurus_skipToContent_fallback)
...
[are ways](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#gitignore) [around this](https://moonrepo.dev/docs/config/toolchain#routeoutdirtocache).
...
## Preface [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#preface "Direct link to Preface")
...
## Configuration [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#configuration "Direct link to Configuration")
...
### Root-level [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#root-level "Direct link to Root-level")
...
#### `tsconfig.json` [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#tsconfigjson "Direct link to tsconfigjson")
...
common compiler options in a root [`tsconfig.options.json`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#tsconfigoptionsjson) file, that this
...
> [`typescript.rootConfigFileName`](https://moonrepo.dev/docs/config/toolchain#rootconfigfilename).

#### `tsconfig.options.json` [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#tsconfigoptionsjson "Direct link to tsconfigoptionsjson")
...
> [`typescript.rootOptionsConfigFileName`](https://moonrepo.dev/docs/config/toolchain#rootoptionsconfigfilename).

##### ECMAScript interoperability [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#ecmascript-interoperability "Direct link to ECMAScript interoperability")
...
#### `.gitignore` [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#gitignore "Direct link to gitignore")
...
### Project-level [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#project-level "Direct link to Project-level")
...
#### `tsconfig.json` [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#tsconfigjson-1 "Direct link to tsconfigjson-1")
...
form, this file should extend the root [`tsconfig.options.json`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#tsconfigoptionsjson) to inherit
common compiler options, define its own compiler options (below), define includes/excludes, and any
necessary references.

> When using moon, the name of the file can be customized with
> [`typescript.projectConfigFileName`](https://moonrepo.dev/docs/config/toolchain#projectconfigfilename).
...
[gitignored](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#gitignore)!
...
> [`typescript.routeOutDirToCache`](https://moonrepo.dev/docs/config/toolchain#routeoutdirtocache), to avoid littering
> the repository with compilation artifacts.

##### Includes and excludes [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#includes-and-excludes "Direct link to Includes and excludes")
...
##### Depending on other projects [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#depending-on-other-projects "Direct link to Depending on other projects")

When a project depends on another project (by importing code from it), either using relative paths,
[path aliases](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#using-paths-aliases), or its `package.json` name, it must be declared as a
...
> [`typescript.includeProjectReferenceSources`](https://moonrepo.dev/docs/config/toolchain#syncprojectreferences) for
> `include`.

#### `tsconfig.*.json` [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#tsconfigjson-2 "Direct link to tsconfigjson-2")
...
##### Package publishing [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#package-publishing "Direct link to Package publishing")

As mentioned previously, these configs may be used for npm packages, primarily for generating
TypeScript declarations that are mapped through the `package.json` [`types` (or `typings`) field](https://www.typescriptlang.org/docs/handbook/declaration-files/publishing.html).
...
and the declarations file structure should match 1:1 with the sources structure. The `tsconfig.json` _does not_ guarantee this, as it may include test, config, or arbitrary files, all of which may not
...
[`exports`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#supporting-packagejson-exports) fields, instead of the `outDir` compiler option, and
...
##### Vendor specific [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#vendor-specific "Direct link to Vendor specific")

Some vendors, like [Vite](https://moonrepo.dev/docs/guides/examples/vite), [Vitest](https://moonrepo.dev/docs/guides/examples/vite), and
[Astro](https://moonrepo.dev/docs/guides/examples/astro) may include additional `tsconfig.*.json` files unique to their ecosystem.
We suggest following their guidelines and implementation when applicable.

## Running the typechecker [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#running-the-typechecker "Direct link to Running the typechecker")
...
### On all projects [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#on-all-projects "Direct link to On all projects")

From the root of the repository, run `tsc --build --verbose` to typecheck _all_ projects, as defined
in [tsconfig.json](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#tsconfigjson). TypeScript will generate a directed acyclic graph (DAG) and
...
### On an individual project [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#on-an-individual-project "Direct link to On an individual project")
...
[`typecheck` task](https://moonrepo.dev/docs/guides/examples/typescript).

### On affected projects [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#on-affected-projects "Direct link to On affected projects")
...
## Using `paths` aliases [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#using-paths-aliases "Direct link to using-paths-aliases")
...
### Importing source files from local packages [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#importing-source-files-from-local-packages "Direct link to Importing source files from local packages")
...
> When using moon, the
> [`typescript.syncProjectReferencesToPaths`](https://moonrepo.dev/docs/config/toolchain#syncprojectreferencestopaths)
> setting will automatically create `paths` based on the local references.

## Sharing and augmenting types [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#sharing-and-augmenting-types "Direct link to Sharing and augmenting types")
...
## Supporting `package.json` exports [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#supporting-packagejson-exports "Direct link to supporting-packagejson-exports")
...
### State of the npm ecosystem [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#state-of-the-npm-ecosystem "Direct link to State of the npm ecosystem")
...
With that being said, there are [ways around this](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#resolving-issues) and moving forward is
possible, if you dare!

### Enabling imports/exports resolution [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#enabling-importsexports-resolution "Direct link to Enabling imports/exports resolution")

To start, set the `moduleResolution` compiler option to "nodenext" (for packages) or "bundler" (for
apps) in the [`tsconfig.options.json`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#tsconfigoptionsjson) file.
...
Next, [run the typechecker from the root](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#on-all-projects) against all projects. This will help
...
more information on [resolving them](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#resolving-issues).
...
### Resolving issues [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#resolving-issues "Direct link to Resolving issues")
...
## Editor integration [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#editor-integration "Direct link to Editor integration")
...
### VS Code [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#vs-code "Direct link to VS Code")
...
![](https://moonrepo.dev/assets/images/vscode-status-1c68ec4790b8766b34a5e91cba1231d7.png)
...
## FAQ [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#faq "Direct link to FAQ")

### I still have questions, where can I ask them? [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#i-still-have-questions-where-can-i-ask-them "Direct link to I still have questions, where can I ask them?")
...
### Do I have to use project references? [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#do-i-have-to-use-project-references "Direct link to Do I have to use project references?")
...
### What about not using project references and only using source files? [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#what-about-not-using-project-references-and-only-using-source-files "Direct link to What about not using project references and only using source files?")
...
[by using `paths` aliases](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#importing-source-files-from-local-packages).
...
### How to integrate with ESLint? [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#how-to-integrate-with-eslint "Direct link to How to integrate with ESLint?")
...
### How to handle circular references? [​](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs\#how-to-handle-circular-references "Direct link to How to handle circular references?")

Project references _do **not** support_
_[circular references](https://github.com/microsoft/TypeScript/issues/33685)_ (cycles), which is
...
- [Preface](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#preface)
- [Configuration](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#configuration)
  - [Root-level](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#root-level)
    - [`tsconfig.json`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#tsconfigjson)
    - [`tsconfig.options.json`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#tsconfigoptionsjson)
      - [ECMAScript interoperability](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#ecmascript-interoperability)
    - [`.gitignore`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#gitignore)
  - [Project-level](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#project-level)
    - [`tsconfig.json`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#tsconfigjson-1)
      - [Includes and excludes](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#includes-and-excludes)
      - [Depending on other projects](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#depending-on-other-projects)
    - [`tsconfig.*.json`](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#tsconfigjson-2)
      - [Package publishing](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#package-publishing)
      - [Vendor specific](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#vendor-specific)
- [Running the typechecker](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#running-the-typechecker)
  - [On all projects](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#on-all-projects)
  - [On an individual project](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#on-an-individual-project)
  - [On affected projects](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#on-affected-projects)
- [Using `paths` aliases](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#using-paths-aliases)
  - [Importing source files from local packages](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#importing-source-files-from-local-packages)
- [Sharing and augmenting types](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#sharing-and-augmenting-types)
- [Supporting `package.json` exports](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#supporting-packagejson-exports)
  - [State of the npm ecosystem](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#state-of-the-npm-ecosystem)
  - [Enabling imports/exports resolution](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#enabling-importsexports-resolution)
  - [Resolving issues](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#resolving-issues)
- [Editor integration](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#editor-integration)
  - [VS Code](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#vs-code)
- [FAQ](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#faq)
  - [I still have questions, where can I ask them?](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#i-still-have-questions-where-can-i-ask-them)
  - [Do I have to use project references?](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#do-i-have-to-use-project-references)
  - [What about not using project references and only using source files?](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#what-about-not-using-project-references-and-only-using-source-files)
  - [How to integrate with ESLint?](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#how-to-integrate-with-eslint)
  - [How to handle circular references?](https://moonrepo.dev/docs/guides/javascript/typescript-project-refs#how-to-handle-circular-references)