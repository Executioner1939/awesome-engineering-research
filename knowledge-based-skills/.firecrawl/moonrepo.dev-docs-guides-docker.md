[Skip to main content](https://moonrepo.dev/docs/guides/docker#__docusaurus_skipToContent_fallback)
...
## Requirements [​](https://moonrepo.dev/docs/guides/docker\#requirements "Direct link to Requirements")
...
## Creating a `Dockerfile` [​](https://moonrepo.dev/docs/guides/docker\#creating-a-dockerfile "Direct link to creating-a-dockerfile")

info

Our [`moon docker file`](https://moonrepo.dev/docs/commands/docker/file) command can automatically generate a `Dockerfile` based on this
...
### What we're trying to avoid [​](https://moonrepo.dev/docs/guides/docker\#what-were-trying-to-avoid "Direct link to What we're trying to avoid")
...
### Scaffolding the bare minimum [​](https://moonrepo.dev/docs/guides/docker\#scaffolding-the-bare-minimum "Direct link to Scaffolding the bare minimum")
...
This can all be achieved with the [`moon docker scaffold`](https://moonrepo.dev/docs/commands/docker/scaffold) command, which scaffolds a
...
This assumes [`moon docker scaffold <project>`](https://moonrepo.dev/docs/commands/docker/scaffold) is ran outside of the `Dockerfile`.
...
### Copying necessary source files [​](https://moonrepo.dev/docs/guides/docker\#copying-necessary-source-files "Direct link to Copying necessary source files")
...
Luckily our [`moon docker scaffold <project>`](https://moonrepo.dev/docs/commands/docker/scaffold) command has already done this for us! Let's
...
`docker.scaffold` settings in [`.moon/workspace.yaml`](https://moonrepo.dev/docs/config/workspace#scaffold) (entire
workspace) or [`moon.*`](https://moonrepo.dev/docs/config/project#scaffold) (per project).

### Pruning extraneous files [​](https://moonrepo.dev/docs/guides/docker\#pruning-extraneous-files "Direct link to Pruning extraneous files")

Now that we've ran a command or built an artifact, we should prune the Docker environment to remove
unneeded files and folders. We can do this with the [`moon docker prune`](https://moonrepo.dev/docs/commands/docker/prune) command, which
...
[`.moon/workspace.yaml`](https://moonrepo.dev/docs/config/workspace#prune).

### Final result [​](https://moonrepo.dev/docs/guides/docker\#final-result "Direct link to Final result")
...
## Running `docker` commands [​](https://moonrepo.dev/docs/guides/docker\#running-docker-commands "Direct link to running-docker-commands")
...
## Troubleshooting [​](https://moonrepo.dev/docs/guides/docker\#troubleshooting "Direct link to Troubleshooting")

### Supporting `node:alpine` images [​](https://moonrepo.dev/docs/guides/docker\#supporting-nodealpine-images "Direct link to supporting-nodealpine-images")

If you're trying to use the `node:alpine` image with moon's
[integrated toolchain](https://moonrepo.dev/docs/concepts/toolchain), you'll need to set the `MOON_TOOLCHAIN_FORCE_GLOBALS`
...
- [Requirements](https://moonrepo.dev/docs/guides/docker#requirements)
- [Creating a `Dockerfile`](https://moonrepo.dev/docs/guides/docker#creating-a-dockerfile)
  - [What we're trying to avoid](https://moonrepo.dev/docs/guides/docker#what-were-trying-to-avoid)
  - [Scaffolding the bare minimum](https://moonrepo.dev/docs/guides/docker#scaffolding-the-bare-minimum)
  - [Copying necessary source files](https://moonrepo.dev/docs/guides/docker#copying-necessary-source-files)
  - [Pruning extraneous files](https://moonrepo.dev/docs/guides/docker#pruning-extraneous-files)
  - [Final result](https://moonrepo.dev/docs/guides/docker#final-result)
- [Running `docker` commands](https://moonrepo.dev/docs/guides/docker#running-docker-commands)
- [Troubleshooting](https://moonrepo.dev/docs/guides/docker#troubleshooting)
  - [Supporting `node:alpine` images](https://moonrepo.dev/docs/guides/docker#supporting-nodealpine-images)