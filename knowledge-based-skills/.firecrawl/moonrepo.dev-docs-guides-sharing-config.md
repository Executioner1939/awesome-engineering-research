[Skip to main content](https://moonrepo.dev/docs/guides/sharing-config#__docusaurus_skipToContent_fallback)
...
[`.moon/workspace.*`](https://moonrepo.dev/docs/config/workspace#extends),
[`.moon/toolchains.*`](https://moonrepo.dev/docs/config/toolchain#extends),
[`.moon/extensions.*`](https://moonrepo.dev/docs/config/extensions#extends), and
[`.moon/tasks/**/*`](https://moonrepo.dev/docs/config/tasks#extends). This setting requires a HTTPS URL _or_ relative file
...
## Versioning [​](https://moonrepo.dev/docs/guides/sharing-config\#versioning "Direct link to Versioning")
...
### Using versioned filenames [​](https://moonrepo.dev/docs/guides/sharing-config\#using-versioned-filenames "Direct link to Using versioned filenames")
...
### Using branches, tags, or commits [​](https://moonrepo.dev/docs/guides/sharing-config\#using-branches-tags-or-commits "Direct link to Using branches, tags, or commits")
...
- [Versioning](https://moonrepo.dev/docs/guides/sharing-config#versioning)
  - [Using versioned filenames](https://moonrepo.dev/docs/guides/sharing-config#using-versioned-filenames)
  - [Using branches, tags, or commits](https://moonrepo.dev/docs/guides/sharing-config#using-branches-tags-or-commits)